...
impl CssParser {
    ...
    pub fn parse_stylesheet(&mut self) -> StyleSheet {
        ...
        stylesheet.set_rules(self.consume_list_of_rules());
        stylesheet
    }
    ...
    fn consume_list_of_rules(&mut self) -> Vec<QualifiedRule> {
        ...
        loop {
            ...
            match token {
                ...
                CssToken::AtKeywork(_keyword) => {
                    let _rule = self.consume_qualified_rule();
                    // @ から始まるルールはサポートしないので、無視する
                }
                _ => {
    ...
    fn consume_selector(&mut self) -> Selector {
        ...
        match token {
            ...
            CssToken::Ident(ident) => {
                // a:hover のようなセレクタはタイプセレクタとして扱うため、もしコロン (:) が出てきた場合は
...
mod tests {
    ...
    fn test_one_rule() {
        ...
        declaration.set_value(CssToken::Ident("red".to_string()));
    ...
    fn test_multiple_rules() {
        ...
        declaration1.set_value(CssToken::StringToken("Hey".to_string()));
        ...
        declaration3.set_value(CssToken::Ident("blue".to_string()));
